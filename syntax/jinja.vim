...
syn keyword jinjaStep containedin=jinjaTagBlock contained step end_step
...
if v:version >= 508 || !exists("did_jinja_syn_inits")
  ...
  HiLink jinjaStepDelim jinja

  HiLink jinjaSpecial Special
  hi def jinjaStep ctermfg=190  guifg=#d7ff00  "rgb=215,255,0
